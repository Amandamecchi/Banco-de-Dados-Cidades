...
5- UPDATE cidades_brasil SET fundacao = '1960-04-21' WHERE id = 64;
...
10- UPDATE cidades_brasil SET prefeito = 'Lupercio Nascimento' WHERE estado = 'Mato Grosso';
...
14- UPDATE cidades_brasil SET populacao = 1667341 WHERE id = 200;
...
17- UPDATE cidades_brasil SET estado = 'Sergipe' WHERE id = 23;
